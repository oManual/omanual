         ...
         <p>
              A procedure is a structured collection of steps. Each must include text and media. For consistency of display, we recommend each step consist of either 1-3 images or one rich media object, as well as no more than eight lines of text.
         </p>
         ...
         <div class="tagListing" id="procedure">
               ...
               <div class="subtag" id="title">
                  ...
                  <div class="tag req">
                     ...
                     <p class="desc">
                        DateTime when this procedure was first created. Format (YYYY-MM-DDThh:mm:ss).
                     </p>
                     <div>
                        <ul class="attr">
                           <li class="attr-intro">Attributes: None</li>
                     ...
                     <div class="tag">
                        ...
                        <div>
                           <ul class="attr">
                              ...
                              <li><strong>guid</strong> <em>optional</em> A global string identifier for the part.</li>
